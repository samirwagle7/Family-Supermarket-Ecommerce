    ...
    <div class="left-dash-sec section-p1">
        ...
        <div class="recent-order">
                ...
                <div class="container">
                    ...
                    <button class='generate-pdf' onclick="window.location.href='allOrdersReport.php'">Generate PDF Report</button>
                </div>
            </div>
        ...
        <div class="sidebar">
            ...
            <nav>
                <ul>
                    ...
                    <li><a class="active" href="#"><i class="fas fa-box-open"></i> Order Product's List</a></li>
